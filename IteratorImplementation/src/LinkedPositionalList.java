...
public class LinkedPositionalList<E> implements PositionalList<E> {
	public ElementListIterator listIterator() {

		return new ElementListIterator();

	}

	public ElementListIterator listIterator(int i) {

		return new ElementListIterator(i);

	}

	public class ElementListIterator implements java.util.ListIterator<E> {
		...
		public ElementListIterator() {

		}

		public ElementListIterator(int i) {
...
// To control Flag and Remove call
			nextFlag = false;
			prevFlag = false;
// To control add sitiuation for next() next call
			if (size() == 0) {
				addFirst(arg0);
				cursor = first();
			...
			LinkedPositionalList.this.addAfter(cursor, arg0);
			recent = cursor;
			cursor = after(cursor);

			/*
			 * System.out.println(LinkedPositionalList.this.toString());
			 * System.out.println("Recent: "+recent.getElement() );
			 * System.out.println("Cursor: "+cursor.getElement() );
			 */
		...
		public boolean hasNext() {
			...
			if (prevFlag) {
				return (after(cursor)) != null;

			}

			boolean control = (cursor != null);
			return control;
		}
		...
		public void set(E e) {
			...
			if (nextFlag || prevFlag) {
				...
				LinkedPositionalList.this.validate(recent).setElement(e);
				nextFlag = false;
				prevFlag = false;
